...
## Research — Packet capture output

Investigate capturing the network traffic generated by a sendit session and writing it as a PCAP file for analysis in Wireshark or similar tools. Related to [#70](https://github.com/lewta/sendit/issues/70).
